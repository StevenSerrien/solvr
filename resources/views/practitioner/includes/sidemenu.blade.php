<nav class='d-sidemenu'>
  ...
  <li><a class='item {{ active_route('practitioners.exercises.show') }}' href="{{ route('practitioners.exercises.show') }}" target="_self"><i class='icon-users'></i>Clienten</a></li>
  <li><a class='item {{ active_route('practitioner.clients.show') }}' href="{{ route('practitioner.clients.show') }}" target="_self"><i class='icon-bell'></i>Meldingen</a></li>
